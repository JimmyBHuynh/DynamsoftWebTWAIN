...
%><%
	...
	String _temp_Name = dir + "/Dynamsoft_Upload/_temp_fields_tochange_later";
	...
	while (iter.hasNext()) {
		...
		// Process a file upload
			...
			if(fileName!=null && sizeInBytes!=0){
				File uploadedFile = new File(dir + "/Dynamsoft_Upload/" + fileName);
				...
				if(_fieldsTXT.exists())
				{
					_fieldsTXT.renameTo(new File(dir + "/Dynamsoft_Upload/" + fileName.substring(0,fileName.length()-4) + "_1.txt"));
				}
			}
		}
	}		
